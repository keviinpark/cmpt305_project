...
def run_all():
    headers = ["Trace", "D", "Start_Inst", "Cycles", "Exec_Time_ms", "Int_Pct", "FP_Pct", "Branch_Pct", "Load_Pct", "Store_Pct"]
    ...
    for line in output.split('\n'):
        ...
        # We find the value inside the parentheses
            ...
            try:
                ...
                if "Integer" in line: p_int = pct_value
                elif "Floating Point" in line: p_fp = pct_value
                elif "Branch" in line: p_br = pct_value
                elif "Load" in line: p_ld = pct_value
                elif "Store" in line: p_st = pct_value
            except IndexError:
                pass
